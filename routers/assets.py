    ...
    try:
        with conn.cursor() as cursor:
            ...
            """, (
                ...
                asset.version_os           if (asset.version_os           is not None and asset.version_os           != '') else existing["version_os"],
                asset.version_firmware     if (asset.version_firmware     is not None and asset.version_firmware     != '') else existing["version_firmware"],
                asset.version_bios         if (asset.version_bios         is not None and asset.version_bios         != '') else existing["version_bios"],
